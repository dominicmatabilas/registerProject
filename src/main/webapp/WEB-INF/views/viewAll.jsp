    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="viewAllPageGet">View Developers</a></li>
      ...
      <div id="content">
		...
		<table align = "center" border = "1" class = CSSTableGenerator>
			...
			<c:forEach var="listValue" items="${userList}">
                        ...
                        <tr>
                        		<td align = "center">${listValue.id}</td> 
								<td align = "left">${listValue.name}</td> 
                                <td align = "left"> ${listValue.userName}</td> 
                        </tr>
